...
function enterpriseComputing() {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      setIsLoading(true);
      setError(null);
      const collectionName = 'EnterpriseComputingProjects'; // Define the collection name
      try {
  ...
  return (
    ...
    <div className="flex min-h-screen bg-expo-blue">
      ...
      <div className="flex-1 p-4">
        ...
        <h1 className="text-center text-3xl font-bold my-6">Enterprise Computing</h1>
