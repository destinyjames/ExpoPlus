...
function Mechanical() {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      ...
      const collectionName1 = 'Mechanical&ManufacturingEngineeringProjects(Year 4)';
      const collectionName2 = 'Mechanical&ManufacturingEngineeringProjects(Year 5)';  
      const url = `${process.env.NEXT_PUBLIC_NGROK_URL}/projects2?collection1=${encodeURIComponent(collectionName1)}&collection2=${encodeURIComponent(collectionName2)}&page=${currentPage}&limit=${projectsPerPage}`;
  ...
  return (
    ...
    <div className="flex min-h-screen bg-expo-blue">
      ...
      <div className="flex-1 p-4">
        ...
        <h1 className="text-center text-3xl font-bold my-6">Mechanical & Manufacturing Engineering</h1>
